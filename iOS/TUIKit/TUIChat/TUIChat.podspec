Pod::Spec.new do |spec|
  ...
  spec.subspec 'DataProvider' do |dataProvider|
    dataProvider.source_files = 'DataProvider/*.{h,m,mm}'
  ...
  spec.subspec 'Service' do |service|
    service.source_files = 'Service/*.{h,m,mm}'
